...
, 			{
				"box" : 				{
					...
					"saved_object_attributes" : 					{
						"filename" : "maw.util.remove-char.js",
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 90.5, 36.0, 34.0, 17.0 ],
					"text" : "store",
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "maw.util.readwrite.maxpat",
				"bootpath" : "/Users/caroline/Desktop/school/Golan/p2/projectFuzz",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
