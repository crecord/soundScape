...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 37.0, 3.0, 16.0, 18.0 ],
					"text" : ">"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 398.0, 6.0, 81.0, 17.0 ],
					"text" : "maw.util.var-init #1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 4.0, 18.0, 17.0 ],
					"text" : "W"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 52.0, 2.0, 149.0, 17.0 ],
					"text" : "#1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 35.0, 2.0, 16.0, 17.0 ],
					"rounded" : 0
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/caroline/Downloads/mawLib/dist/mawLib/mawLib-Support/Abstractions/util",
				"patcherrelativepath" : "../../../../../Downloads/mawLib/dist/mawLib/mawLib-Support/Abstractions/util",
				"type" : "JSON",
				"implicit" : 1
			}
 ]
